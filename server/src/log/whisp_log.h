...
#define WHISP_LOG_TRACE(...)    TalkLog::getInstance().log(LogLevel::TRACE, __FILE__, __LINE__, __VA_ARGS__)
#define WHISP_LOG_DEBUG(...)    TalkLog::getInstance().log(LogLevel::DEBUG, __FILE__, __LINE__, __VA_ARGS__)
#define WHISP_LOG_INFO(...)     TalkLog::getInstance().log(LogLevel::INFO, __FILE__, __LINE__, __VA_ARGS__)
#define WHISP_LOG_WARN(...)     TalkLog::getInstance().log(LogLevel::WARN, __FILE__, __LINE__, __VA_ARGS__)
#define WHISP_LOG_ERROR(...)    TalkLog::getInstance().log(LogLevel::ERROR, __FILE__, __LINE__, __VA_ARGS__)
#define WHISP_LOG_CRITICAL(...) TalkLog::getInstance().log(LogLevel::CRITICAL, __FILE__, __LINE__, __VA_ARGS__)
