...
our %config = (
  ...
  openssldir => "/home/ubuntu/project/talko/server/third_party/openssl-1.1.1q/../openssl-dist",
  options => "--prefix=/home/ubuntu/project/talko/server/third_party/openssl-1.1.1q/../openssl-dist --openssldir=/home/ubuntu/project/talko/server/third_party/openssl-1.1.1q/../openssl-dist no-asan no-buildtest-c++ no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-ec_nistp_64_gcc_128 no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-md2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-unit-test no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.38.2",
  perlargv => [ "linux-x86_64", "--prefix=/home/ubuntu/project/talko/server/third_party/openssl-1.1.1q/../openssl-dist", "--openssldir=/home/ubuntu/project/talko/server/third_party/openssl-1.1.1q/../openssl-dist" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  prefix => "/home/ubuntu/project/talko/server/third_party/openssl-1.1.1q/../openssl-dist",
  processor => "",
